...
public class GetSourceCode {
    ...
    public static Map<String, MPathInfo> getCodeAndGetMPathInfo(String url) {
        ...
        for (String tag : allTags) {
            try {
                Git git = Git.cloneRepository().setURI(url).setBranch(tag).setDirectory(new File(ServiceConfig.CODE_DIWNLOAD_PATH + "/" + projectName + "_" + tag)).call();
...
//                mPathInfo.setGitUrl(url);
    ...
    public static MPathInfo getCodeByVersion(String url, String version) {
        ...
        File file = new File(ServiceConfig.CODE_DIWNLOAD_PATH + "/" + projectName + "_" + version);
        if (file.exists()) {
...
//        mPathInfo.setGitUrl(url);
    ...
    public static MPathInfo getMPathInfo(String version, String projectName) {
        String path = ServiceConfig.CODE_DIWNLOAD_PATH + "/" + projectName + "_" + version + "/";
    ...
    public static List<String> getAllTags(String url, String projectname) {
        deleteDir(ServiceConfig.CODE_DIWNLOAD_PATH);
        String p = ServiceConfig.CODE_DIWNLOAD_PATH + "/" + projectname;
        Git git = null;
        try {
